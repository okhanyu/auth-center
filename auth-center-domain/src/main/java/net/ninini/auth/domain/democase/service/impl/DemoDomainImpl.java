package net.ninini.auth.domain.democase.service.impl;

import net.ninini.auth.domain.democase.entity.bo.DemoBO;
import net.ninini.auth.domain.democase.factory.DemoEntityFactory;
import net.ninini.auth.domain.democase.service.DemoDomain;
import lombok.extern.slf4j.Slf4j;
import net.ninini.auth.infrastructure.page.PageAssembler;
import net.ninini.auth.infrastructure.page.PageDTO;
import net.ninini.auth.infrastructure.page.PageData;
import net.ninini.auth.infrastructure.remote.DemoRemoteClient;
import net.ninini.auth.repository.facade.IDemoRepository;
import net.ninini.auth.repository.po.DemoMongoPojo;
